...
![OFDM]({{site.baseurl}}/assets/img/OFDM/OFDM_carrier.png){:height="450px" width="45%" style="display: block; margin: 0 auto"}
...
based on IEEE 802.11a system specifications.
...
| <b>USRP N210</b> ![OFDM]({{site.baseurl}}/assets/img/OFDM/ofdm_usrp.jpg){:height="450px" width="45%" style="display: block; margin: 0 auto"} |
